...
class MissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $missions = [
            ['titre' => 'Maintenance préventive d’une ligne de production', 'description' => 'Nous recherchons un technicien pour effectuer la maintenance préventive d’une ligne de production industrielle et contrôler les différents équipements.', 'localisation' => 'Casablanca', 'budget' => 4500, 'priorite' => 'Haute', 'statut' => 'ouverte'],
            ...
            ['titre' => 'Maintenance d’un système hydraulique', 'description' => 'Intervention de maintenance corrective sur un système hydraulique industriel.', 'localisation' => 'Marrakech', 'budget' => 3600, 'priorite' => 'Moyenne', 'statut' => 'ouverte'],
