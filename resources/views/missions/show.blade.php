                        ...
                        <div class="mt-5 flex items-center justify-between">
                            ...
                            <div class="text-center">
                                ...
                                <div
                                    ...
                                    {{ in_array($mission->statut, ['Affectée', 'En cours', 'Terminée']) ? 'bg-blue-600 text-white' : 'bg-slate-200 text-slate-400' }}"
                                >
                                    {{ in_array($mission->statut, ['Affectée', 'En cours', 'Terminée']) ? '✓' : '2' }}
                                </div>
                            ...
                            <div class="text-center">
                                ...
                                <div
                                    class="mx-auto flex h-8 w-8 items-center justify-center rounded-full
                                    {{ in_array($mission->statut, ['En cours', 'Terminée']) ? 'bg-blue-600 text-white' : 'bg-slate-200 text-slate-400' }}"
                                >
                                    {{ in_array($mission->statut, ['En cours', 'Terminée']) ? '✓' : '3' }}
                                </div>
                            ...
                            <div class="text-center">
                                ...
                                <div
                                    class="mx-auto flex h-8 w-8 items-center justify-center rounded-full
                                    {{ $mission->statut === 'Terminée' ? 'bg-blue-600 text-white' : 'bg-slate-200 text-slate-400' }}"
                                >
                                    {{ $mission->statut === 'Terminée' ? '✓' : '4' }}
                                </div>
