@if (auth()->user()->role === 'Admin')
    ...
    <div class="min-h-screen bg-slate-50">
        <div class="flex min-h-screen">
            ...
            @include('components.admin-sidebar', ['admin' => $admin])
                    ...
                    <div class="mx-auto max-w-7xl">
                        ...
                        <div class="mb-8 flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
                            <div>
                                ...
                                <h1 class="mt-1 text-3xl font-extrabold tracking-tight text-slate-950">
                                    Vue administrateur
                                </h1>

                                <p class="mt-2 text-sm text-slate-500">
                                    Supervisez l’activité de MaintenanceConnect depuis un espace centralisé.
                                </p>
                            </div>
                        ...
                        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                            ...
                            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <p class="mt-1 text-xs text-slate-500">
                                    {{ $nombreEntreprises }} entreprises · {{ $nombreTechniciens }} techniciens
                                </p>
                            </div>
                        ...
                        <section class="mt-8 grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
                            ...
                            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                                ...
                                <div class="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs text-slate-500">
                                            Les missions les plus récemment enregistrées.
                                        </p>
                                    </div>

                                    <a href="{{ route('missions.index') }}"
                                       class="text-xs font-bold text-sky-700 hover:text-sky-800">
                                        Tout voir
                                    </a>
                                            ...
                                            <tr class="text-sm">
                                                ...
                                                <td class="px-5 py-4">
                                                    <a href="{{ route('missions.show', $mission) }}"
                                                       class="font-bold text-slate-800 hover:text-sky-700">
                                                        {{ $mission->titre }}
                                                    </a>
                                                </td>
                            ...
                            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                                ...
                                <div class="border-b border-slate-100 px-5 py-4">
                                    ...
                                    <p class="mt-1 text-xs text-slate-500">
                                        Les dernières propositions des techniciens.
                                    </p>
                                ...
                                <div class="divide-y divide-slate-100">
                                    ...
                                    @forelse ($dernieresOffres as $offre)
                                        ...
                                        <a href="{{ route('missions.show', $offre->mission) }}"
                    ...
                    <section class="mc-panel overflow-hidden">
                        ...
                        <div class="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-slate-500">
                                    Suivez vos publications et les offres reçues.
                                </p>
                            </div>

                            <a href="{{ route('missions.create') }}"
                               class="rounded-lg bg-sky-700 px-4 py-2 text-sm font-bold text-white hover:bg-sky-800">
                                Publier
                            </a>
                        ...
                        <div class="divide-y divide-slate-100">
                            ...
                            @forelse ($missions as $mission)
                                ...
                                <a href="{{ route('missions.show', $mission) }}"
                                   class="flex flex-col gap-2 px-5 py-4 transition hover:bg-slate-50 sm:flex-row sm:items-center sm:justify-between">
                ...
                @else
                    ...
                    <section class="mc-panel overflow-hidden">
                        ...
                        <div class="border-b border-slate-100 px-5 py-4">
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Retrouvez le suivi de vos propositions.
                            </p>
