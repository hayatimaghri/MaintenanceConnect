<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            Mettez à jour votre nom, votre adresse email et vos coordonnées de compte.
        </p>
    </header>
    ...
    <form x-data="{ submitting: false }" @submit="submitting = true" method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        @csrf
        @method('patch')
